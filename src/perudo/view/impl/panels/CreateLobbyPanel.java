...
public class CreateLobbyPanel extends JPanel {
    ...
    private final static int TURN_TIME_DEF = 60;
    private final static int DICE_NUM_DEF = 5 - GameSettingsImpl.MIN_INITIAL_DICE_NUMBERS;
    private final static int DICE_VALUE_DEF = 6 - GameSettingsImpl.MIN_DICE_FACES;
    private final static int PLAYER_NUM_DEF = 4 - GameSettingsImpl.MIN_PLAYER_NUMBERS;
    ...
    public CreateLobbyPanel() {
        ...
        this.sldTime = (JSlider) this.factory.createSliderHorizontal((int) GameSettingsImpl.MIN_TURN_TIME.getSeconds(),
